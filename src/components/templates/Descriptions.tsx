...
export const Descriptions = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-200 pb-5 lg:pb-10">
      <div className="flex justify-center items-center p-2 mt-5 font-bold bg-yellow-300 text-xl md:text-4xl md:px-4 md:mt-10 lg:px-5 lg:mt-20 lg:text-5xl">
        対象の害虫・害獣
      </div>
