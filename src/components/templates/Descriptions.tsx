...
export const Descriptions = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-200 pb-5 md:mt-24 md:pt-24 md:pb-10">
      <div className="flex justify-center items-center p-2 mt-5 font-bold tex-red-600 bg-yellow-300 text-2xl md:px-5 md:mt-20 md:text-5xl">
        対象の害虫
      </div>
