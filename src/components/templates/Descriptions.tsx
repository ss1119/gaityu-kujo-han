...
export const Descriptions = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-200 pb-3 lg:pb-8">
      <div className="flex justify-center items-center p-2 my-3 font-bold bg-yellow-300 text-xl xs:text-base xs:py-1 md:text-4xl md:px-4 md:my-5 lg:px-5 lg:my-10 lg:text-5xl">
        対象の害虫一覧
      </div>
