export const Damage = () => {
  return (
    <div className="flex flex-col items-center bg-gray-200 pb-5 md:pt-14 md:pb-10">
      <div className="flex justify-center items-center p-2 font-bold bg-blue-300 text-2xl md:px-5 md:text-5xl">
        こんな<span className="text-red-600">被害</span>にお悩みはありませんか？
      </div>
      <div className="flex">
        <div className="flex flex-col pt-2 md:pt-24 md:mr-10">
          <div className="flex items-center">
            <img src="assets/checkbox.png" className="md:w-24 md:ml-24" />
          ...
          <div className="flex items-center">
            <img
              src="assets/damages/damage3.png"
              className="w-64 md:ml-24 md:w-96"
            />
            <img src="assets/cloud.svg" className="w-64 md:w-96" />
          </div>
        </div>
        <div>
